  ...
  return (
    <div style={{ paddingBottom: 'calc(9rem + env(safe-area-inset-bottom, 0px))' }}>
      ...
      <div className="mt-3 flex items-center gap-2">
        <div className="h-5 w-24 animate-pulse rounded-[var(--radius-sm)] bg-neutral-100" />
      ...
      {/* Action button */}
      <div className="mt-8 h-12 w-full animate-pulse rounded-[var(--radius-md)] bg-neutral-100" />
    </div>
  )
}
