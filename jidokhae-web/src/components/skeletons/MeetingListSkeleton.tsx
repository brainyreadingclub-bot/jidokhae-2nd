function SkeletonCard() {
  return (
    <div className="rounded-[var(--radius-lg)] border-l-[3px] border-neutral-200 bg-white px-4 py-4 shadow-[var(--shadow-card)]">
      <div className="mb-2 flex items-center gap-2">
        <div className="h-5 w-20 animate-pulse rounded-[var(--radius-sm)] bg-neutral-100" />
