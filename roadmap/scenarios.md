...
## WP3-1. 모임 일정 목록 (회원 뷰) ✅ (2026-03-10 검증 완료)
...
## WP3-2. 모임 상세 페이지 + 목록 "신청완료" 뱃지 ✅ (2026-03-10 검증 완료)
...
## WP3-3. 운영자 모임 관리 (CRUD) ✅ (2026-03-10 검증 완료)
...
## WP6-1. E2E 검증 + 버그 수정 ✅ (2026-03-19 검증 완료)
...
- **Given:** 정원 3명 모임에 confirmed 2건이 있는 상태. 2개의 브라우저/세션에서 마지막 1자리에 동시 결제
...
| v1.8 | 2026-03-19 | M4/M5 검증 완료 표시. WP6-1 검증 완료 (STEP 1~11 통과, STEP 12 실사용자 피드백으로 대체) |
